      ...
      <article className="bg-white border border-slate-100 rounded-3xl md:rounded-[3rem] shadow-xl overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500 relative">
        ...
        <div className="p-6 sm:p-8 md:p-16 space-y-8 md:space-y-10">
          ...
          <div className="ql-snow">
            {/* ★ 변경된 부분: 모바일은 화면의 1/2, PC는 화면의 1/4 크기로 조정 (w-1/2 md:w-1/4) */}
            <div
              className="ql-editor prose prose-slate prose-sm sm:prose-base md:prose-lg max-w-none prose-headings:font-black prose-a:text-indigo-600 prose-ul:list-disc prose-img:w-1/2 md:prose-img:w-1/4 prose-img:h-auto prose-img:mx-auto prose-img:rounded-2xl prose-img:shadow-sm !p-0"
